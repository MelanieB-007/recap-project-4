...
export default function AddColorForm({
    ...
    // Deine update-Funktionen bleiben gleich...
    function updateHex(event) { setHex(event.target.value); }
    function updateContrastText(event) { setContrastText(event.target.value); }
    function updateRole(event) { setRole(event.target.value); }

    // Deine addColor/updateColor bleiben gleich...
